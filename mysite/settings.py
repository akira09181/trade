...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'for.send.mail.use.iwa@gmail.com'
EMAIL_HOST_PASSWORD = 'voxxoddlqhgmaaky'
EMAIL_USE_TLS = True
...
SECRET_KEY = '%i8)7d5n#bv(rtxy#nw_18$tv7^8d_akieug)q$ro-zz#2d8@o'
